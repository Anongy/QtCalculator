...
const long long int MAX_SIG_NUM = 999999999999; //最大有效数字
const int MAX_DIGIT = 10; //最大有效数位
...
public:
	...
	const string printcnum(bool& haderror); //错误输出与格式输出
};
...
private:
	...
	calculate_number answer = {"0",0,0}; //操作结果 
public:
	Calculator();
